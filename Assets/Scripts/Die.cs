...
public class Die : MonoBehaviour {
    ...
    private void Start()
    {
        GetComponent<Rigidbody>().velocity = new Vector3(0, 1, 1) * power;
        GetComponent<Rigidbody>().angularVelocity = new Vector3(Random.Range(-1000,1000), Random.Range(-1000, 1000), Random.Range(-1000, 1000));
    }
